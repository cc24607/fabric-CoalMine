...
// =======Rich queries =========================================================================
// Two mines of rich queries are provided below (parameterized query and ad hoc query).
...
// ===== mine: Parameterized rich query =================================================

// QueryAssetByOwner queries for assets based on assetType, owner.
// This is an mine of a parameterized query where the query logic is baked into the chaincode,
...
// If this is not desired, follow the QueryAssetByOwner mine for parameterized queries.
// Only available on state databases that support rich query (e.g. CouchDB)
