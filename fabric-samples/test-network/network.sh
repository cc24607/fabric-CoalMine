...
function createOrgs() {
  ...
  if [ "$CRYPTO" == "cfssl" ]; then
    ...
    peer_cert peer peer0.org1.mine.com org1
    peer_cert admin Admin@org1.mine.com org1

    infoln "Creating Org2 Identities"
    #function_name cert-type   CN   org
    peer_cert peer peer0.org2.mine.com org2
    peer_cert admin Admin@org2.mine.com org2

    infoln "Creating Orderer Org Identities"
    #function_name cert-type   CN   
    orderer_cert orderer orderer.mine.com
    orderer_cert admin Admin@mine.com
...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    ${CONTAINER_CLI} volume rm docker_orderer.mine.com docker_peer0.org1.mine.com docker_peer0.org2.mine.com
