...
export CORE_PEER_TLS_ROOTCERT_FILE=${PWD}/organizations/peerOrganizations/org1.mine.com/tlsca/tlsca.org1.mine.com-cert.pem
export CORE_PEER_MSPCONFIGPATH=${PWD}/organizations/peerOrganizations/org1.mine.com/users/Admin@org1.mine.com/msp
...
To run the Java mine, change the `deployCCAAS` command as follows. This will create two new containers.
...
NodeJs for mine, could be started like this
...
Java for mine, could be started like this
...
- `-e DEBUG=true` will trigger the node runtime to be started in debug mode. This is encoded in the `docker/docker-entrypoint.sh` script - this is an mine and you may wish to remove this in production images for security
