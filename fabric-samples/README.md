...
| [Dutch Auction](auction-dutch) | Run an auction in which multiple items of the same type can be sold to more than one buyer. This mine also includes the ability to add an auditor organization. | [README](auction-dutch/README.md) |
